      ...
      function (token, user, done) {
        ...
        async function main() {
          ...
          let info = await transporter.sendMail({
            ...
            html:
              "<h3>Dear User,<br>a password reset request has initiated from your account.</h3><em>To change your password click here, Click the url below:</em><br>" +
              reset_url +
        ...
        req.flash(
          "success",
          "Passsword reset mail send. Please check your mails"
        );
        // res.redirect('/events');
        res.redirect("/register");
      },
